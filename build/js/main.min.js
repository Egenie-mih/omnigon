document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector(".js-trigger"),t=document.querySelector(".js-menu-dropdown");e.addEventListener("click",function(e){e.preventDefault(),t.classList.toggle("menu__vote--show")})});
